...
func TestProductController_UpdateProduct_InvalidIdParam(t *testing.T) {
	product_service.ProductService = &productServiceMock{}
	...
	req := httptest.NewRequest(http.MethodPut, "/products/idngasal", bytes.NewBufferString(requestBody))
...
func TestProductController_GetProducts_Success(t *testing.T) {
	...
	assert.EqualValues(t, len(products), 1)
	assert.EqualValues(t, expectedVal[0].Id, products[0].Id)
	assert.EqualValues(t, expectedVal[0].Name, products[0].Name)
	assert.EqualValues(t, expectedVal[0].Price, products[0].Price)
	assert.EqualValues(t, expectedVal[0].Stock, products[0].Stock)
}

func TestProductController_GetProducts_ServerError(t *testing.T) {
	product_service.ProductService = &productServiceMock{}
...
func TestProductController_DeleteProduct_Success(t *testing.T) {
	...
	deleteProduct = func(productId int64) error_utils.MessageErr {
		return nil
	}
...
func TestProductController_DeleteProduct_InvalidIdParam(t *testing.T) {
	product_service.ProductService = &productServiceMock{}

	req := httptest.NewRequest(http.MethodDelete, "/products/idngasal", nil)
...
func TestProductController_DeleteProduct_ServerError(t *testing.T) {
	product_service.ProductService = &productServiceMock{}
